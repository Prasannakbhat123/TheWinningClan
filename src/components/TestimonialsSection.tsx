  ...
  return (
    <section id="testimonials" className="border-b border-white/10 py-20">
      <div className="max-w-3xl space-y-3" data-aos="fade-up">
        <p className="text-sm uppercase tracking-[0.4em] text-[#f4d35e]">Testimonials</p>
        <h2 className="text-3xl leading-snug md:text-4xl">Leaders trust us to engineer momentum.</h2>
      ...
      <div
        className="mt-12 rounded-[30px] border border-[#f4d35e33] bg-[radial-gradient(circle_at_top_right,rgba(244,211,94,0.25),transparent_40%),rgba(3,12,30,0.85)] p-8"
        data-aos="fade-up"
      >
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#01091c]/80 py-5">
          <div className="flex gap-6 animate-marquee">
            {[...testimonials, ...testimonials].map((testimonial, index) => (
              <article
                className="min-w-[320px] max-w-[360px] rounded-2xl border border-[#f4d35e33] bg-[rgba(11,45,83,0.7)] p-6 shadow-[0_18px_35px_rgba(0,0,0,0.3)]"
