        ...
        <div className="rounded-[32px] border border-[#f4d35e59] bg-[linear-gradient(135deg,rgba(5,16,36,0.9),rgba(16,52,96,0.8))] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.35)] md:p-12">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            <a
              ...
              className="rounded-2xl border border-[#f4d35e66] bg-[rgba(7,22,45,0.7)] sm:p-6 p-4 text-left hover:bg-[rgba(7,22,45,0.85)] transition-all duration-300 hover:border-[#f4d35e] cursor-pointer"
              data-aos="fade-right"
            >
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                ...
                <p className="text-sm sm:text-base font-semibold text-[#f4d35e] break-all">
                  thewinningclan11@gmail.com
                </p>
              </div>
            </a>
            <a
